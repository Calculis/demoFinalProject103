...
//        trimOut(this);
    ...
    public void trim(VeryLongInteger e) {
        if (e.getVeryLongInteger().size() == this.veryLongInteger.size()) {
            return;
        }
    ...
    public String setFormat(){
        int temp= this.toString().length()-1;
        ArrayList<Character> result= new ArrayList<>();
        
        for(int l=0;l<this.toString().length();l++){
            result.add(toString().charAt(l));
        }
